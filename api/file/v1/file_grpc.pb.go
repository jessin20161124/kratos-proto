...
const (
	FileServer_GetFile_FullMethodName = "/file.v1.FileServer/GetFile"
)
...
func (c *fileServerClient) GetFile(ctx context.Context, in *FileRequest, opts ...grpc.CallOption) (*FileReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FileReply)
	err := c.cc.Invoke(ctx, FileServer_GetFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFileServerServer) GetFile(context.Context, *FileRequest) (*FileReply, error) {
...
func _FileServer_GetFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServerServer).GetFile(ctx, req.(*FileRequest))
	}
...
var FileServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "file.v1.FileServer",
